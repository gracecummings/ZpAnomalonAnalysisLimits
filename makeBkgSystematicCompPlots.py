...
if __name__=='__main__':
    ...
    for syst in systs:
        ...
        if rebindiv == 2:
           ...
           #hack way for pileup
           dyEstup     = ROOT.TFile(config.get(syst,'pathup')+'/Run2_161718_dy_extraploationalphat_systnominal_hem_kf_btag_muid_mutrig_eltrig_elid_elreco__Zptcut100.0_Hptcut300.0_metcut75.0_btagwp0.8.root')
           dyEstdwn     = ROOT.TFile(config.get(syst,'pathdwn')+'/Run2_161718_dy_extraploationalphat_systnominal_hem_kf_btag_muid_mutrig_eltrig_elid_elreco__Zptcut100.0_Hptcut300.0_metcut75.0_btagwp0.8.root')
        ...
        #Extra plots
        #dynormup = np.load(config.get(syst,'pathup')+'/Run2_161718_dynormalization_alphat_'+config.get(syst,'strup')+'_signalblind_Zptcut100.0_Hptcut300.0_metcut75.0_btagwp0.8.npy')[0]
        #dynormnom = np.load(config.get(syst,'pathnom')+'/Run2_161718_dynormalization_alphat_'+config.get(syst,'strnom')+'_signalblind_Zptcut100.0_Hptcut300.0_metcut75.0_btagwp0.8.npy')[0]
        #dynormdwn = np.load(config.get(syst,'pathdwn')+'/Run2_161718_dynormalization_alphat_'+config.get(syst,'strdwn')+'_signalblind_Zptcut100.0_Hptcut300.0_metcut75.0_btagwp0.8.npy')[0]
        ...
        #print('hzz up integral: ',hzzuppt.Integral())
       ...
       # 
        ...
        tcbkg.cd()
#        ptdy.Draw()
#        CMS_lumi.extraText = "Z+jets estimation"
#        ptdy.cd()
#        hdyuppt.Draw('hist')
#        hdypt.Draw('histsame')
...
#        tcbkg.cd()
#        ptvv.Draw()
#        CMS_lumi.extraText = "VV estimation"
#        ptvv.cd()
#        hvvuppt.Draw('hist')
#        hvvpt.Draw('histsame')
