...
if __name__=='__main__':
    ...
    pathbkg    = 'BkgInputsNominalRebin/'
    pathdata   = 'DataInputsNominalRebin/'
    zptcut  = '150.0'
    hptcut  = '300.0'
    metcut  = '200.0'
    btagwp  = '0.8'
    ...
    bkgs = go.backgrounds(pathbkg,zptcut,hptcut,metcut,btagwp)
    ...
    hbkgaddition.Add(hdyclone)

    print("The integral of the added backgrounds is: ",hbkgaddition.Integral())
    print("The integral of the stack backgrounds is: ",hsbkgnorm.GetStack().Last().Integral())

    #ratio vals for scaled DY
    ...
    pd12 = ROOT.TPad("pd22","datfitratio",0.5,0,1.0,.25)
