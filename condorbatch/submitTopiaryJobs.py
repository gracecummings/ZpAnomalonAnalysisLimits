...
if __name__=='__main__':
    ...
    parser.add_argument("-syst","--syststr",type=str,default="",help="the systematic flag you want topiary to make")
    ...
    if len(fsjson.keys()) > 0:
        for key in fsjson.keys():
            for samp in fsjson[key]:
                ...
                eosForOutput = "root://cmseos.fnal.gov//store/user/lpcboostres/"+sampleName+"_"+str(date.today())
