...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TreeMakerTopiary(TTree *tree=0,int sampt=0,int year=0,int anchan=0,int jecsys=0);
   virtual ~TreeMakerTopiary();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree, int sampt,int year,int anchan,int jecsys);
   virtual void     Loop(std::string entry,float entry1,int entry2,int year,int anchan,int jecsys);
...
TreeMakerTopiary::TreeMakerTopiary(TTree *tree,int sampt,int year,int anchan,int jecsys) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   ...
   Init(tree,sampt,year,anchan,jecsys);
}
...
void TreeMakerTopiary::Init(TTree *tree, int sampt, int year, int anchan,int jecsys)
{
