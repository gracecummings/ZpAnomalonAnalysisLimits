...
if __name__=='__main__':
    ...
    #samples
    bkgupout17 = gecorg.gatherBkg('pfMETNominal_CorrCounting_Optimization','upout_sideband_systnominal_btagnom',zptcut,hptcut,metcut,btagwp,17)
    bkgupout18 = gecorg.gatherBkg('pfMETNominal_CorrCounting_Optimization','upout_sideband_systnominal_btagnom',zptcut,hptcut,metcut,btagwp,18)
    bkgnames   = ["DYJetsToLL","TT","WZTo2L2Q","ZZTo2L2Q"]
    sigfiles   = glob.glob('pfMETNominal_CorrCounting_Optimization/Autumn18.ZpAnomalonHZ_UFO*_upout_sideband_systnominal_btagnom*_Zptcut'+str(zptcut)+'_Hptcut'+str(hptcut)+'_metcut'+str(metcut)+'_btagwp'+str(btagwp)+'.root')
    datfiles17 = glob.glob('pfMETNominal_CorrCounting_Optimization/Run2017*upout_sideband_systnominal_btagnom*_Zptcut'+str(zptcut)+'_Hptcut'+str(hptcut)+'_metcut'+str(metcut)+'_btagwp'+str(btagwp)+'.root')
    datfiles18 = glob.glob('pfMETNominal_CorrCounting_Optimization/Run2018*upout_sideband_systnominal_btagnom*_Zptcut'+str(zptcut)+'_Hptcut'+str(hptcut)+'_metcut'+str(metcut)+'_btagwp'+str(btagwp)+'.root')
    
    bkguncs17  = pd.read_pickle('pfMETNominal_CorrCounting_Optimization/Fall17.AllZpAnomalonBkgs_unc_'+reg+'_Zptcut'+str(zptcut)+'_Hptcut'+str(hptcut)+'_metcut'+str(metcut)+'_btagwp'+str(btagwp)+'.pkl')
    bkguncs18  = pd.read_pickle('pfMETNominal_CorrCounting_Optimization/Autumn18.AllZpAnomalonBkgs_unc_'+reg+'_Zptcut'+str(zptcut)+'_Hptcut'+str(hptcut)+'_metcut'+str(metcut)+'_btagwp'+str(btagwp)+'.pkl')
    datuncs17  =pd.read_pickle('pfMETNominal_CorrCounting_Optimization/Run2017.AllZpAnomalonData_unc_'+reg+'_Zptcut'+str(zptcut)+'_Hptcut'+str(hptcut)+'_metcut'+str(metcut)+'_btagwp'+str(btagwp)+'.pkl')

    datuncs18  =pd.read_pickle('pfMETNominal_CorrCounting_Optimization/Run2018.AllZpAnomalonData_unc_'+reg+'_Zptcut'+str(zptcut)+'_Hptcut'+str(hptcut)+'_metcut'+str(metcut)+'_btagwp'+str(btagwp)+'.pkl')
